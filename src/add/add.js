...
import { logOperationFailed, logInvalidInput, FILENAME_REGEXP, throwCustomError, INVALID_INPUT_ERROR } from '../utils.js'
...
export const add = async (currentPath, fileName) => {
  try {
    ...
    process.stdout.write(`Empty file was created in ${filePath}`)
  } catch (err) {
